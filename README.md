...
Учебный проект системы проверки качества табличных данных и обнаружения сдвигов распределений. Участники: Михаил и Павел.

**Дедлайн проекта: 27.09.2026, 23:59.** Текущий план охватывает только **07.09–13.09.2026**.
...
Для общей среды команды выбран Python 3.12; пакет объявляет поддержку Python 3.11 и новее.
