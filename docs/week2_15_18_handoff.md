...
Change set объединён PR #12: merge commit `c98ce13`. Последующая калибровка,
интерфейсная и deployment-приёмка объединены PR #15; release candidate —
`c33d95b`. Фактические результаты 19–20.09 и остаток до дедлайна перенесены в
[week2_19_20_handoff.md](week2_19_20_handoff.md).
