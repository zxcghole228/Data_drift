...
Контрольный прогон 17.09.2026 на Windows 11 и Python 3.13.7: `282 passed`
за 42.70 секунды. Ручной smoke test подтвердил создание JSON и автономного
HTML для `none` с кодом `0` и `combined` с кодом `2` при
`--fail-on-alert`.
