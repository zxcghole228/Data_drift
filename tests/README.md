...
Реализованы unit-тесты отдельных модулей и [интеграционные тесты общего pipeline](integration/test_pipeline.py). Каждый участник добавляет содержательные проверки одновременно со своим модулем.
