...
Первые unit-тесты загрузки реализованы в [unit/test_ingestion.py](unit/test_ingestion.py). Каждый участник добавляет содержательные проверки одновременно со своим модулем.
