...
Реализованы unit-тесты отдельных модулей, [интеграционные тесты общего pipeline](integration/test_pipeline.py) и [проверки Streamlit-интерфейса](integration/test_streamlit_app.py). Каждый участник добавляет содержательные проверки одновременно со своим модулем.
...
| Streamlit | Явный запуск, успешный анализ, ошибка файла, сброс и сохранение результата | Павел |
| End-to-end | CSV/Parquet → схема/качество → статистика/ML → JSON | Михаил и Павел |
